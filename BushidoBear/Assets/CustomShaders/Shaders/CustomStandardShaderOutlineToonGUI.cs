...
{
	internal class CustomStandardShaderOutlineToonGUI : ShaderGUI
	{
		...
		private static class Styles
		{
			...
			public static GUIContent toonRampText = new GUIContent("Toon Ramp", "Toon Ramp");
		...
		// Toon Added -------------------------------------------------------- //
		MaterialProperty toonRamp = null;
		MaterialProperty toonScale = null;
		...
		public void FindProperties (MaterialProperty[] props)
		{
			...
			// Toon Add --------------------------------------------------------- //
			toonRamp = FindProperty ("_Ramp", props);
			toonScale = FindProperty("_ToonScale", props);
		}
		...
		public void ShaderPropertiesGUI (Material material)
		{
			...
			EditorGUI.BeginChangeCheck();
			{
				...
				//Toom Ramp ------------------------------------------------------------- //
				GUILayout.Label ("Toon Properties", EditorStyles.boldLabel);
				m_MaterialEditor.TexturePropertySingleLine(Styles.toonRampText, toonRamp, toonRamp.textureValue != null ? toonScale : null);
			}
			if (EditorGUI.EndChangeCheck())
			{
